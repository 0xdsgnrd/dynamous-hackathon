...
2. **Vary everything**: Light/dark themes, different fonts, different aesthetics. No two designs should look the same.

3. **Interpret creatively**: Make unexpected choices that feel genuinely designed for the context.

4. **Commit fully**: Elegance comes from executing the vision well, not hedging between styles.
