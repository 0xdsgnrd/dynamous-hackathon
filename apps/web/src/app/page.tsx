    ...
    <main className={`min-h-screen transition-all duration-500 ${easterEgg ? "dark-mode-v1" : ""}`}>
      ...
      <div className="fixed bottom-20 right-6 z-50">
        <a
          ...
          className="card-brutal px-4 py-3 flex flex-col gap-2 text-sm hover:border-[var(--accent)] transition-colors"
        >
          <div className="flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
            <span className="font-mono">
              Built in <span className="text-accent font-bold">43 min</span>
            </span>
          </div>
          <div className="text-xs text-[var(--fg-muted)] font-mono">
            12:23 → 13:06 EST • 1.16.2026
          </div>
          <div className="text-xs text-[var(--fg-muted)] flex items-center gap-1">
            ...
            <span className="underline">Verify on GitHub</span>
          </div>
        </a>
      </div>
